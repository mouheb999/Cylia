 ...
 *
 * Le titre est posé **au milieu de la photo**, et non plus dessous. Seuls les
 * mots ont bougé ; le reste est à sa place, et c'est voulu :
 *
 ...
 *    d'un pixel.
 *
 * Sous la photo reste donc la bande noire qui portait le texte, désormais
 * vide. Le voile y descendait déjà jusqu'au noir complet : elle prolonge la
 * photo sans qu'on voie de couture.
 */
    ...
    <section id="haut" className="relative min-h-[calc(125vw+18rem)] bg-noir">
      <div className="relative aspect-[4/5] w-full">
        ...
        */}
        ...
        {/* Les mots, au milieu de la photo — et rien d'autre n'a bougé. */}
        <div className="absolute inset-0 z-10 flex flex-col justify-center px-6 text-center">
          <Texte
            cle="hero.surtitre"
